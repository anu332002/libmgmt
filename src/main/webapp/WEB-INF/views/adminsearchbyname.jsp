...
<caption><h3>Hi,${user.username}! Here is the searching result.</h3></caption> <!-- ${userId} --> <!-- Role is : ${user.role} -->
<thead>
<tr>
	<th>Book ID</th>
	<th>Book Name</th>
...
<button type="submit" class="btn btn-success" onclick="form1.action='${pageContext.request.contextPath }/bookcontrol/searchsomebooks'">Back to Previous Page</button>
	</div>
</form:form>
</body>
</html>